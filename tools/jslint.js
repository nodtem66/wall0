...
if(!JSLINT(input,{sloppy: true,bitwise:true,eqeqeq:true,immed:true,newcap:true,nomen:true,onevar:false,plusplus:false,regexp:false,rhino:true,undef:true,white:true,browser: true,windows: true,devel:true,predef:['IMPORT_LIB','IMPORT_NORMALIZE','IMPORT_HISTORY','restoreNormalState', 'addResizeUITo', 'removeResizeUIFrom', 'console', 'sandbox', 'stage', 'getPropStyle', 'ActiveXObject','window','define']})){for(var i=0;i<JSLINT.errors.length;i+=1){var e=JSLINT.errors[i];if(e){print('Lint at line '+(e.line+1)+' character '+
